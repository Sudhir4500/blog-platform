...
SECRET_KEY = 'django-insecure-trd8=tezp#@h=q$^cxl3sss!6!k$i1owq^a3+5&m^#wc^xen!b'
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",
    "https://blogplatform4500.netlify.app",
]
...
# Allow credentials if using cookies or auth tokens
